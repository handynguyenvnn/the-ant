...
class TAAboutUsViewController: BaseViewController {
    ...
    var isFAQ = false
    let arrData1 = ["Thông tin điều khoản","Phản hồi","Câu hỏi thường gặp","Mời bạn bè","Liên hệ","Đánh giá ứng dụng","Chuyển khoản thanh toán"]
...
//    }
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print(indexPath.row)
        if isFAQ{
            let listAskedVC = QuanStoryBoard.instantiateViewController(withIdentifier: "TAListAskedViewController") as! TAListAskedViewController
            ...
            case 6:
                ...
                ATM.isCheckVC = true
                self.navigationController?.pushViewController(ATM, animated: true)
                break
            default:
                break
            }
