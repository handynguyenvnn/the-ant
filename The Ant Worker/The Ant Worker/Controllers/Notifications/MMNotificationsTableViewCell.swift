...
let COLOR_NOTIFICATION_READ_LINE = UIColor.init(red: 255/255, green: 213/255, blue: 213/255, alpha: 1)
...
//        viewShadow?.backgroundColor = UIColor.clear
    ...
    func setupData(objData: NotificationObj)
    {
        ...
        self.icIcon?.sd_setImage(with: URL.init(string: objData.notificationIcon ?? ""), placeholderImage: UIImage.init(named: "ic_non_image-1"), options:.refreshCached , completed: nil)
